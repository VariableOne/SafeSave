  ...
  public async upload({ request, params, view, session }: HttpContext) {
    ...
    if (!file) {
      ...
      return view.render('pages/home', {
        ...
        folders,
        error:
          'Datei konnte nicht hochgeladen werden. Sieh unter "Allgemein",welche Dateiformate erlaubt sind!',
      })
    }
    ...
    await file.move(app.publicPath('uploads'), { name: `${file.clientName}` })
  ...
  public async deleteFile({ request, session, view }: HttpContext) {
    ...
    if (!checkPassword) {
      ...
      return view.render('pages/home', {
        ...
        files,
        folders,
        error: 'Datei konnte nicht gelöscht werden! Das Passwort ist falsch.',
      })
    }
